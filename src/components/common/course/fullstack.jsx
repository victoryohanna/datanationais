            ...
            <div className="collapse-section3">
              ...
              <div className="collapse" id="collapse3">
                <div className=" pp">
                  <ul>
                    <li>
                      Introduction to popular FullStack frameworks (e.g., React,
                      Vue.js)
                    </li>
                    <li>
                      Building components and managing state in FullStack
                      frameworks
                    </li>
                    <li>Introduction to component-based architecture</li>
                    <li>
                      Working with FullStack libraries and packages (e.g.,
                      jQuery)
                    </li>
                    <li>
              ...
              <div className="collapse" id="collapse4">
                <div className=" pp">
                  <ul>
                    ...
                    <li>
                      Optimizing FullStack assets (e.g., minification,
                      concatenation)
                    </li>
                    <li>
