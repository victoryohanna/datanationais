  ...
  return (
    <div className="modules">
      <div className="course-overview">
        <h4>Frontend Course Overview</h4>
        <p>
            ...
            <div className="collapse-section3">
              ...
              <div className="collapse" id="collapse3">
                <div className=" pp">
                  <ul>
                    <li>
                      Introduction to popular frontend frameworks (e.g., React,
                      Vue.js)
                    </li>
                    <li>
                      Building components and managing state in frontend
                      frameworks
                    </li>
                    <li>Introduction to component-based architecture</li>
                    <li>
                      Working with frontend libraries and packages (e.g.,
                      jQuery)
                    </li>
                    <li>
