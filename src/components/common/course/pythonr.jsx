            ...
            <div className="collapse-section3">
              <p>
                <button
                  ...
                  aria-controls="collapseExample"
                >
                  RPython Frameworks and Libraries
                </button>
              </p>
              <div className="collapse" id="collapse3">
                <div className=" pp">
                  <ul>
                    <li>
                      Introduction to popular RPython frameworks (e.g., React,
                      Vue.js)
                    </li>
                    <li>
                      Building components and managing state in RPython
                      frameworks
                    </li>
              ...
              <div className="collapse" id="collapse4">
                <div className=" pp">
                  <ul>
                    ...
                    <li>
                      Optimizing RPython assets (e.g., minification,
                      concatenation)
                    </li>
                    <li>
